"""
Regression tests for Attas-owned standalone pulser demo configs.
"""
...
def test_attas_pulser_demo_configs_instantiate_expected_agents():
    """Verify Attas pulser demo configs instantiate the expected agents."""
    root = _repo_root()
