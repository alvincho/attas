...
Verwenden Sie WSL2 mit Ubuntu oder einer anderen Linux-Distribution. Führen Sie im Root-Verzeichnis des Repositorys innerhalb von WSL die gleichen Befehle aus:
```bash
python3 -m venv .venv
source .venv/bin/activate
pip install --upgrade pip
