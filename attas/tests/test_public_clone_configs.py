...
`test_public_clone_system_pulser_uses_local_filesystem_backend`, and
...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("attas/configs/file_storage.pulser", SystemPulser, "SystemPulser", 8067),
    ],
)
...
def test_public_clone_system_pulser_uses_local_filesystem_backend():
    """
    Exercise the
    test_public_clone_system_pulser_uses_local_filesystem_backend
    regression scenario.
    """
